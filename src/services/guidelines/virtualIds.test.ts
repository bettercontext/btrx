...
describe('virtualIds', () => {
  describe('generateVirtualId', () => {
    it('should generate a consistent ID for the same inputs', () => {
      ...
      const id1 = generateVirtualId(contextId, content, line)
      const id2 = generateVirtualId(contextId, content, line)
    ...
    it('should generate different IDs for different content', () => {
      ...
      const id1 = generateVirtualId(contextId, 'First guideline', line)
      const id2 = generateVirtualId(contextId, 'Second guideline', line)
    ...
    it('should generate different IDs for different context IDs', () => {
      ...
      const id1 = generateVirtualId(1, content, line)
      const id2 = generateVirtualId(2, content, line)
    ...
    it('should generate different IDs for different line numbers', () => {
      ...
      const id1 = generateVirtualId(contextId, content, 0)
      const id2 = generateVirtualId(contextId, content, 1)
    ...
    it('should handle special characters in content', () => {
      ...
      const id = generateVirtualId(1, specialContent, 0)
    ...
    it('should handle large context IDs and line numbers', () => {
      const id = generateVirtualId(999999, 'Content', 999999)
    ...
    it('should handle unicode content', () => {
      ...
      const id = generateVirtualId(1, unicodeContent, 0)
  ...
  describe('parseGuidelinesToVirtual', () => {
    ...
    it('should handle guidelines with identical content but different lines', () => {
      ...
      expect(result[0].id).not.toBe(result[1].id) // Different lines should have different IDs
    })
  ...
  describe('findGuidelineByVirtualId', () => {
    ...
    it('should find existing guideline by virtual ID', () => {
      ...
      const virtualId = generateVirtualId(
        contextId,
        expectedGuideline.content,
        expectedGuideline.line,
      )
    ...
    it('should find guideline with special characters', () => {
      ...
      const virtualId = generateVirtualId(
        contextId,
        specialGuideline.content,
        specialGuideline.line,
      )
    ...
    it('should find guideline with unicode content', () => {
      ...
      const virtualId = generateVirtualId(
        contextId,
        unicodeGuideline.content,
        unicodeGuideline.line,
      )
    ...
    it('should not find guideline when context ID differs', () => {
      ...
      const virtualId = generateVirtualId(1, guideline.content, guideline.line)
  ...
  describe('integration tests', () => {
    ...
    it('should maintain ID stability across multiple operations', () => {
      ...
      const id1 = generateVirtualId(
        contextId,
        guideline.content,
        guideline.line,
      )
      const id2 = generateVirtualId(
        contextId,
        guideline.content,
        guideline.line,
      )
    ...
    it('should handle complex scenarios with mixed content', () => {
      ...
      const complexGuidelines: ParsedGuideline[] = [
        ...
        { content: '   ', active: false, line: 1 }, // Whitespace only
        ...
        { content: '\n\t\r', active: true, line: 4 }, // Special whitespace chars
