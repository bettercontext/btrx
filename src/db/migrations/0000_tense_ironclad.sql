...
--> statement-breakpoint
ALTER TABLE "guidelines" ADD CONSTRAINT "guidelines_context_id_guidelines_contexts_id_fk" FOREIGN KEY ("context_id") REFERENCES "public"."guidelines_contexts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
